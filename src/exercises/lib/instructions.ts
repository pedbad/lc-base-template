...
export const EXERCISE_INSTRUCTIONS: Record<ExerciseType, string> = {
  ...
  reading:
    'Read the passage, then answer each question below it. Select **Check** to mark your answers, **Reset** to clear them, or **Show answers** to reveal the correct choices.',
};
