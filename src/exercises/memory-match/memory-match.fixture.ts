        ...
        items: [
          {
            ...
            audio: 'audio/showcase-demo/memory-match/circulo.mp4',
            localLanguage: 'circle',
          },
          {
            text: 'el cuadrado',
            image: 'images/line-match/square.svg',
            audio: 'audio/showcase-demo/memory-match/cuadrado.mp4',
            localLanguage: 'square',
          },
          {
            text: 'el triángulo',
            image: 'images/line-match/triangle.svg',
            audio: 'audio/showcase-demo/memory-match/triangulo.mp4',
            localLanguage: 'triangle',
          },
          {
            text: 'la estrella',
            image: 'images/line-match/star.svg',
            audio: 'audio/showcase-demo/memory-match/estrella.mp4',
            localLanguage: 'star',
          },
        ],
